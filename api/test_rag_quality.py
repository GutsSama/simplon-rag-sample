...
async def main():
    ...
    async with async_session() as session:
        ...
        tests = [
            ...
            (
                "Transverse (Compétences)",
                "Quelles compétences transversales sont évaluées dans le parcours IA ?",
            ),
            (
                "Piège (Médecine)",
                "Quel est le règlement pour les étudiants en médecine ?",
            ),
        ]
